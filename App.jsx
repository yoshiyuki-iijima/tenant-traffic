...
const BUILDINGS = [
  {
    ...
    area: "汐留・新橋エリア",
    workers: 9000,
    // [分, 出社率%]  11:00 / 11:15 / 11:30
    base: [[660, 70], [675, 75], [690, 80]],
    hold: 80, // 11:30以降キープ → 15:00から5%/15分減
...
function getOccupancy(b, mins) {
  ...
  if (mins < t1) return p0;            // 11:00〜11:14
  if (mins < t2) return p1;            // 11:15〜11:29
  if (mins < declineStart) return p2;  // 11:30〜14:59（キープ）
  const steps = Math.floor((mins - declineStart) / 15) + 1; // 15:00から
